...
const Logo = ({ theme = 'default' }: LogoProps): JSX.Element => (
  <Link to="/">
    <div className={[classes.logo, classes[`logo--${theme}`]].join(' ')}>
      <svg width="12" height="44.81" viewBox="0 0 12 44.81">
        <g transform="translate(-319.715 -30)">
          ...
          />
          <rect width="7.032" height="18.411" rx="3.516" transform="translate(322.243 50.221)" />
        </g>
      </svg>

      <span className={classes.name}>Beerly</span>
    </div>
  </Link>
);
